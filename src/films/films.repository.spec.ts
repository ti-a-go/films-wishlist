...
describe('FilmsRepository', () => {
    ...
    describe('findOneByTitleYearAndLanguage', () => {
        it('Should find a film', async () => {
            ...
            typeOrmRepository.findOne.mockImplementation(() => Promise.resolve(mockFilm))
        ...
        it('Should throw', async () => {
            ...
            // Then
            expect(async () => await repository.findOneByTitleYearAndLanguage(
                title, year, language
    ...
    describe('save', () => {
        it('Should save a film', async () => {
            ...
            typeOrmRepository.save.mockImplementation(() => Promise.resolve(createdFilm))
            ...
            expect(typeOrmRepository.save).toHaveBeenNthCalledWith(1, filmToBeCreated)
        })
        ...
        it('Should throw', async () => {
            ...
            // Then
            expect(async () => await repository.save(filmToBeCreated)).rejects.toThrow(Error)
            expect(typeOrmRepository.save).toHaveBeenNthCalledWith(1, filmToBeCreated)
        })
    })
