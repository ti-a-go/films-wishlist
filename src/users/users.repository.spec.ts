...
describe('FilmsRepository', () => {
    ...
    describe('save', () => {
        it('Should save a user', async () => {
            ...
            typeOrmRepository.save.mockImplementation(() => Promise.resolve(expectedUser))
        ...
        it('Should throw', () => {
            ...
            typeOrmRepository.save.mockImplementation(() => Promise.reject(new Error()))

            // Then
            expect(async () => await repository.save(userToBeSaved)).rejects.toThrow(Error)
            expect(typeOrmRepository.save).toHaveBeenNthCalledWith(1, userToBeSaved)
        })
    })
    ...
    describe('findByName', () => {
        it('Should find a user', async () => {
            ...
            typeOrmRepository.findOne.mockImplementation(() => Promise.resolve(expectedUser))
            ...
            // Then
            expect(user).toEqual(expectedUser)
            expect(typeOrmRepository.findOne).toHaveBeenNthCalledWith(1, expectedParams)
        })
        ...
        it('Should throw', () => {
            ...
            typeOrmRepository.findOne.mockImplementation(() => Promise.reject(new Error))
            ...
            // Then
            expect(async () => await repository.findByName(name)).rejects.toThrow(Error)
            expect(typeOrmRepository.findOne).toHaveBeenNthCalledWith(1, expectedParams)
        })
    ...
    describe('findUserWithWishlist', () => {
        ...
        it('Should throw', () => {
            ...
            // Then
            expect(async () => await repository.findUserWithWishlist(id)).rejects.toThrow(Error)
            expect(typeOrmRepository.findOne).toHaveBeenNthCalledWith(1, expectedParams)
        })
    })
})